...
Public Class Form1
    ...
    Private Sub btnTambah_Click(sender As Object, e As EventArgs) Handles btnTambah.Click
        Call koneksi()
        Dim query As String = "INSERT INTO layanan (nama, harga, kategori) VALUES (@nama, @harga, @kategori)"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Call koneksi()
        Dim query As String = "UPDATE layanan SET nama=@nama, harga=@harga, kategori=@kategori WHERE id=@id"
        cmd = New MySqlCommand(query, conn)
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        Call koneksi()
        Dim query As String = "DELETE FROM layanan WHERE id=@id"
        cmd = New MySqlCommand(query, conn)
        cmd.Parameters.AddWithValue("@id", dgvData.CurrentRow.Cells(0).Value)
        cmd.ExecuteNonQuery()
    ...
    Private Sub btnCari_Click(sender As Object, e As EventArgs) Handles btnCari.Click
        Call koneksi()
        da = New MySqlDataAdapter("SELECT * FROM layanan WHERE nama LIKE '%" & txtCari.Text & "%'", conn)
        dt = New DataTable
        da.Fill(dt)
        dgvData.DataSource = dt
    End Sub
